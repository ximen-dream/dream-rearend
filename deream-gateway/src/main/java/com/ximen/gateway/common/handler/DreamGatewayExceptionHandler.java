package com.ximen.gateway.common.handler;
 ...
 */
@Slf4j
public class DreamGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {
    public DreamGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
