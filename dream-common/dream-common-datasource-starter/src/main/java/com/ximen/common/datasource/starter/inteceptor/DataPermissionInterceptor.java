package com.ximen.common.datasource.starter.inteceptor;

import com.baomidou.mybatisplus.core.toolkit.PluginUtils;
import com.baomidou.mybatisplus.extension.handlers.AbstractSqlParserHandler;
import com.ximen.common.core.entity.CurrentUser;
import com.ximen.common.core.utils.DreamUtil;
import com.ximen.common.datasource.starter.annotation.DataPermission;
...
public class DataPermissionInterceptor extends AbstractSqlParserHandler implements Interceptor {
    ...
    private String dataPermissionSql(String originSql, DataPermission dataPermission) {
        try {
            ...
            CurrentUser user = DreamUtil.getCurrentUser();
            if (user == null) {
                return originSql;
            }
