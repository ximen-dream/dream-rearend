package com.ximen.system.job.config;
...
public class DreamJobConfigure {
    ...
    public ThreadPoolTaskExecutor scheduleJobExecutorService() {
        ...
        executor.setThreadNamePrefix("Dream-Job-Thread");
    ...
    public SchedulerFactoryBean schedulerFactoryBean() {
        ...
        prop.put(StdSchedulerFactory.PROP_SCHED_INSTANCE_NAME, "DreamCloudScheduler");
        ...
        factory.setSchedulerName("DREAM_Cloud_Scheduler");
        // 延时启动
