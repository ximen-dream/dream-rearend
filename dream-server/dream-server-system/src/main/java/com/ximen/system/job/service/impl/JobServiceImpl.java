package com.ximen.system.job.service.impl;
...
import com.ximen.system.job.helper.ScheduleUtils;
import com.ximen.system.job.mapper.JobMapper;
...
//        SortUtil.handlePageSort(request, page, "createTime", FebsConstant.ORDER_DESC, true);
    ...
    @Override
    public PageResultDTO<Job> page(Integer pagNumber, Integer pageSize, String searchKey) {
        Page pageInfo = new Page(pagNumber,pageSize);
        LambdaQueryWrapper<Job> queryWrapper = null;
        if(StringUtils.isNotBlank(searchKey)) {
            queryWrapper = new LambdaQueryWrapper<Job>();
            queryWrapper.like(Job::getBeanName,searchKey).or().eq(Job::getMethodName,searchKey).or().eq(Job::getRemark,searchKey);
        }
        IPage iPage = this.baseMapper.selectPage(pageInfo, queryWrapper);
