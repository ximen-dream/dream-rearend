...
import com.ximen.zuul.fallback.DreamGatewayBlockFallbackProvider;
...
@Slf4j
@Configuration
public class DreamGatewaySentinelFilter {
    @Bean
    ...
    @PostConstruct
    public void doInit() {
        ZuulBlockFallbackManager.registerProvider(new DreamGatewayBlockFallbackProvider());
        initGatewayRules();
    }
}
